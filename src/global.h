...
#define RAYS_PER_PIXEL_SAMPLE 1 // relevant if depth of field is on
#define CAMERA_LENS_SIZE 0 // relevant if depth of field is on
#define RAYS_PER_LIGHT_SOURCE 1 // relevant if soft-shadows are enabled
